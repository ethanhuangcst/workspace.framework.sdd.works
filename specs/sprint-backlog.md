...
| feature-16 | [Web-portal-12 Instructions tab: sdd-scrum guide](./product-backlog.md#pb-81) | Web-portal | Feature | Guide tab on instructions | - `/` and `/instructions` show a third tab for the sdd-scrum guide. - The tab label is an i18n key in `en`, `zh-Hans`, and `zh-Hant`. - The panel shows the guide for the active locale. - A missing locale file shows the English guide. - Setup and Features still switch. - Get secret stays on Features. | [`sdd-scrum-guide.md`](./framework.seeds/templates/EN/sdd-scrum-guide.md) · [`app-design.md`](./admin-portal/app-design.md) | - Not started. - Does not replace the Features catalog. | ToDo |
