...
| feature-04 | [Web-portal-08 Instructions page — Get secret](./product-backlog.md#pb-74)                                                       | Web-portal | Feature | Secret form at the bottom of Features   | - The Features tab shows the field and button after the template list. - The hint is “Enter the name of the secret, example: sdd-trial-googlemaps”, “输入要获得的密钥名称，例如：sdd-trial-googlemaps”, and the 繁體 line. - The button is “Get secret”, “获取密钥”, and the 繁體 line. - The Setup tab does not show the form.                                                                                                                                                                                                   | `[admin-portal/ui-mockup/01-home.html](./admin-portal/ui-mockup/01-home.html)` · `src/app/instructions/page.tsx`                             | - Strings are i18n keys.                                                                                                                                                                                                                     | ToDo   |
