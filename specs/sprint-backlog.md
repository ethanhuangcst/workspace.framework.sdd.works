...
> **Numbering**: `Code` is the Type plus a two-digit number inside that sprint, such as `task-01`. When citing another document, prefer the item name. Shape: `[framework.seeds/framework-design.md](./framework.seeds/framework-design.md)`.
...
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | --------- | ------------- | ------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------ |
| feature-01       | [Spec-seeds-02 Seed: scrum-in-sdd.md](./product-backlog.md#pb-33) · [Spec-seeds-03 Seed: sdd-scrum-practices.md](./product-backlog.md#pb-34) | Framework | Feature       | Store the latest guide and practices seeds | - The user has reviewed and confirmed this seed. - It is stored in the seed tree. - Associated specs are updated. - The whole seed tree has been cross-reviewed and is consistent. | `[framework.seeds/templates/EN/scrum-in-sdd.md](./framework.seeds/templates/EN/scrum-in-sdd.md)` · `[framework.seeds/templates/EN/sdd-scrum-practices.md](./framework.seeds/templates/EN/sdd-scrum-practices.md)` | - User confirmed the EN guide and practices on 2026-09-25. - Stored under `templates/EN/`. - Process specs point at that path. - Cross-review: Sprint 1 seeds match the tree. - Later sprints own `templates/constants.md`, `templates/EN/.secrets`, empty `agents/` `rules/` `skills/`, `framework-design.md`, and HanS/HanT. | Done   |
...
| documentation-01 | [Spec-seeds-02 Seed: scrum-in-sdd.md](./product-backlog.md#pb-33)                                                                            | Framework | Documentation | Point process docs at the seed tree        | - The user has reviewed and confirmed this seed. - It is stored in the seed tree. - Associated specs are updated. - The whole seed tree has been cross-reviewed and is consistent. | `[artifacts-map.md](./artifacts-map.md)`                                                                                                                                                                                | - User confirmed the EN guide and practices on 2026-09-25. - Root `specs/sdd-scrum-guide.md` and `specs/sdd-scrum-practices.md` are gone. - Process specs point at `templates/EN/`. - Cross-review: Sprint 1 seed links are consistent. - `constants.md` is Sprint 2.                                                          | Done   |
...
| feature-02 | [Agent-15 Pack file: agents/ethan.md](./product-backlog.md#pb-63)                     | Agent      | Feature | Ship ethan.md in the pack                                            | - `specs/framework.seeds/agents/ethan.md` exists. - The frontmatter name is `ethan`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `[agent-ethan/agent-design.md](./agent-ethan/agent-design.md)` · `[framework.seeds/framework-design.md](./framework.seeds/framework-design.md)`                                                                                                            | - Pack copy and install check are go-live. - They are not this item.                                                                                                                                                                                                                                          | Done                                                                                               |
...
| feature-04 | [Web-portal-08 Instructions page — Get secret](./product-backlog.md#pb-74)                                                       | Web-portal | Feature | Secret form at the bottom of Features   | - The Features tab shows the field and button after the catalog. - The hint is “Enter the name of the secret, example: sdd-trial-googlemaps”, “输入要获得的密钥名称，例如：sdd-trial-googlemaps”, and “輸入要取得的密鑰名稱，例如：sdd-trial-googlemaps”. - The button is “Get secret”, “获取密钥”, and “獲取密鑰”. - The Setup tab does not show the form.                                                                                                                                                                                                   | `[app-stories.md](./admin-portal/app-stories.md)` AC7 · `[app-design.md](./admin-portal/app-design.md)` `/instructions` · `[app-test.md](./admin-portal/app-test.md)` · `[13-instructions.html](./admin-portal/ui-mockup/13-instructions.html)` | - Strings are i18n keys `admin.guide.secret_hint` and `admin.guide.secret_button`. - Lookup and showing a value are feature-05.                                                                                                                                                                                                                     | Done   |
| feature-05 | [Web-portal-08 Instructions page — Get secret](./product-backlog.md#pb-74)                                                       | Web-portal | Feature | Get secret returns and shows one value  | - A stored name returns only that plaintext value. - An unknown name is not found. - The response lists no other names or values. - The lookup reads the admin key store on the server. - Submit stays on Features at `#features-secret` (`?tab=features`). - After a result, `secret-result` or `secret-error` is scrolled into view. - A known exact name shows that plaintext in a code block with a copy control, width equal to the secret-lookup row. - An unknown name shows `admin.guide.secret_missing` at the same width and no other values. - An empty name shows `admin.guide.secret_empty` and does not call the lookup API. - The setup paste sentence and `mcp.json` sample stay without a token. | `[mcp/mcp-stories.md](./mcp/mcp-stories.md)` `sdd-mcp-get-key` · `src/core/tools/get-key.ts` · `[product-backlog.md](./product-backlog.md#pb-74)` · `src/components/features/InstructionsPage.tsx` · [`issues-log.md`](./issues-log.md) WA-09 · WA-11 | - Merged the old feature-06 into this row on 2026-09-26. The code feature-06 is retired. Later feature numbers stay as they are. - Does not add a token product. - Does not register `sdd_get_key` on stdio. | Done   |
| feature-07 | [Web-portal-07 Features tab reads pack features.md](./product-backlog.md#pb-73)                                                  | Web-portal | Feature | Features tab reads synced markdown      | - The deployed package includes `src/content/features/features.en.md`, `features.zh-Hans.md`, and `features.zh-Hant.md`. - The pack repo root has those same three filenames. The page reads them first from `.data/sdd-packages/<commit>/`. - The Features tab shows the file for the active locale. The body is free markdown. The page does not require fixed headings. - A missing Chinese file in the chosen source shows that source’s English file. - If the sync cache cannot be read, the page reads the same three files from `src/content/features/`. Setup and Get secret still work. - A pack edit followed by manual sync or the 30-minute sync changes the body without an app deploy. A failed sync still serves the previous file. - There is no admin editor. The three files are not copied onto `{client_root}`. - Tab labels stay i18n keys. | `[product-backlog.md](./product-backlog.md#pb-73)` · `[app-design.md](./admin-portal/app-design.md)` Features catalog · `[app-stories.md](./admin-portal/app-stories.md)` AC12–AC16 · `[app-test.md](./admin-portal/app-test.md)` | - Dan. Mark and Dave do not take this row. - The mock sample is an example, not a required outline. - Build order is task-01 through task-06. - Ethan confirmed usable 2026-09-26. Sync of commit `30cde7ac` served `source: cache`. | Done   |
| feature-08 | [MCP-03 MCP tools without sdd_list_versions](./product-backlog.md#pb-78) | MCP | Feature | Unregister sdd_list_versions | - `create-server.ts` and `create-server-stdio.ts` do not register `sdd_list_versions`. - Stdio `tools/list` is `sdd_install_framework` and `sdd_update_framework` only. - HTTP `tools/list` is those two plus `sdd_get_key`. - `listVersions()` and `GET /api/sdd/versions` still work. - Tests expect exactly those tool lists. - No test expects `sdd_list_versions` on `tools/list`. - `GET /api/sdd/versions` coverage stays. - Install with omitted `version` still resolves latest. | [ADR-063](./adr/ADR-063-unregister-sdd-list-versions.md) · `[mcp/mcp-design.md](./mcp/mcp-design.md)` §3 · `[mcp/mcp-test.md](./mcp/mcp-test.md)` · `src/mcp/create-server.ts` · `src/mcp/create-server-stdio.ts` · `src/mcp/create-server.test.ts` · `src/mcp/local-binary.test.ts` · `src/app/api/sdd/sdd-api.test.ts` | - Does not delete `src/core/tools/list-versions.ts`. - Does not add an MCP resource for versions. - Tests ship with the unregister, not as a later story. - Ethan confirmed usable 2026-09-26. | Done |
| feature-09 | [MCP-03 MCP tools without sdd_list_versions](./product-backlog.md#pb-78) | MCP | Feature | Setup and instructions omit list tool | - `GET /setup` confirm sentence names `sdd_install_framework` and `sdd_update_framework` (and does not name `sdd_list_versions`). - Instructions page `TOOLS` has no `sdd_list_versions` row. - Locale keys for that row are removed from `en`, `zh-Hans`, and `zh-Hant`. - Embedded prompt in mcp-design §2.1 matches `public/agent-setup/prompt.md`. | `public/agent-setup/prompt.md` · `src/components/features/InstructionsPage.tsx` · `messages/en.json` · `messages/zh-Hans.json` · `messages/zh-Hant.json` | - Depends on feature-08 for the live tool list. - Ethan confirmed usable 2026-09-26. | Done |
| feature-10 | [Web-portal-11 Reset success stays on page with previous sentence](./product-backlog.md#pb-79) | Web-portal | Feature | Reset success uses previous sentence | - Success callout uses the previous `admin.reset.sent` sentence (en: “If that email is an admin account, a reset mail is on its way. Check inbox and junk.”; zh-Hans / zh-Hant matching). - Callout does not interpolate `{email}`. - Request lead `admin.reset.lead` is hidden. - URL stays `/reset-password` with no `?email=` document GET. - Submit control cannot issue a document GET. - Back to login remains. | [`issues-log.md`](./issues-log.md) WA-08 · WA-10 · `[app-stories.md](./admin-portal/app-stories.md)` AC4b · `[app-design.md](./admin-portal/app-design.md)` `/reset-password` · `[app-test.md](./admin-portal/app-test.md)` | - Finished before Get secret lookup (now feature-05). - Strings are i18n keys in `en`, `zh-Hans`, and `zh-Hant`. - WA-10 restores the previous sentence after WA-08 introduced `{email}`. | Done |
| feature-11 | [Agent-02 agent ethan — initial capabilities](./product-backlog.md#pb-7) | Agent | Feature | Update ethan.md start load | - The seed `agents/ethan.md` start load is one numbered list. - Step 1 reads only the ledger. Step 2 stops and sends the instructions URL when `pack_complete` is not true. - Step 3 reads constants, the map, the guide, the practices, then the other process and tracking files. - Step 4 reads the first existing copy: artifacts root, workspace template, client-root locale template. Guide and practices use the client-root locale folder when `artifact_locale` is set. - Step 5 does not read `adr/` or `knowledge/` and does not open a skill until asked. - Step 6 treats a missing map, status, or sprint backlog as a stage and does not create a file. An empty workspace means the project is not initialized. - Step 8 answers what to do now and what is next. - [`agent-design.md`](./agent-ethan/agent-design.md) §14 matches the seed. - The prompt does not call install or update. | [`framework.seeds/agents/ethan.md`](./framework.seeds/agents/ethan.md) · [`agent-ethan/agent-design.md`](./agent-ethan/agent-design.md) §2.2 · [`agent-ethan/agent-test.md`](./agent-ethan/agent-test.md) CE-GATE · CE-ORDER | - Do this before feature-02. - Toggle A install recovery in design §6 stays out of this prompt. Agent-07 forbids that call. | WIP |
| feature-12 | [Skill-07 Skill: sdd-tracking](./product-backlog.md#pb-27) | Skill | Feature | Rename update-status to tracking | - Living specs, Features markdown, and locale strings use `sdd-tracking` and `skill_tracking`. - `sdd-update-status` and `skill_update_status` are gone from those files. - [ADR-065](./adr/ADR-065-skill-tracking-not-update-status.md) is accepted. - Practices job 6 stays titled Report status. - This row does not add `SKILL.md`. | [ADR-065](./adr/ADR-065-skill-tracking-not-update-status.md) · `[constants.md](./framework.seeds/templates/constants.md)` | - Sprint 7 feature-01 still writes practices job 6. The initial `SKILL.md` is feature-14. | Done |
| feature-13 | [Skill-14 Skill: sdd-design](./product-backlog.md#pb-80) | Skill | Feature | Skill sdd-design | - `specs/framework.seeds/skills/sdd-design/SKILL.md` exists and the frontmatter name is `sdd-design`. - The skill consolidates the SBI requirement, asks the human about unknowns, completes the design, and does not write production code. - Living skill lists and `constants.md` include `sdd-design`. - [ADR-066](./adr/ADR-066-sdd-design-before-implementation.md) is accepted. | [ADR-066](./adr/ADR-066-sdd-design-before-implementation.md) · `[constants.md](./framework.seeds/templates/constants.md)` | - Install onto `{client_root}` stays with pack copy. - Not a practices job. | Done |
| feature-14 | [Skill-07 Skill: sdd-tracking](./product-backlog.md#pb-27) | Skill | Feature | Initial sdd-tracking skill | - `specs/framework.seeds/skills/sdd-tracking/SKILL.md` exists and the frontmatter name is `sdd-tracking`. - It updates `status.md` from the sprint backlog after confirm and does not mark a PBI Done. - Practices job 6 stays *(to fill)*. | [ADR-065](./adr/ADR-065-skill-tracking-not-update-status.md) | - Sprint 7 feature-01 still writes job 6 and the install check. | Done |
| feature-15 | [Skill-13 Skill: sdd-implement](./product-backlog.md#pb-65) | Skill | Feature | Rename implement-feature to implement | - Living specs use `sdd-implement`. - `sdd-implement-feature` is gone from those files. - `specs/framework.seeds/skills/sdd-implement/SKILL.md` exists and the frontmatter name is `sdd-implement`. - The skill implements one SBI and does not start the next. - [ADR-066](./adr/ADR-066-sdd-design-before-implementation.md) records the rename. | [ADR-066](./adr/ADR-066-sdd-design-before-implementation.md) · `[constants.md](./framework.seeds/templates/constants.md)` | - Sprint 12 still owns the install check. | Done |
| feature-16 | [Web-portal-12 Instructions tab: sdd-scrum guide](./product-backlog.md#pb-81) | Web-portal | Feature | Guide tab on instructions | - `/` and `/instructions` show a third tab for the sdd-scrum guide. - The tab label is an i18n key in `en`, `zh-Hans`, and `zh-Hant`. - The panel shows `scrum-in-sdd.md` for the active locale. - A missing locale file shows the English guide. - Setup and Features still switch. - Get secret is not on the guide tab. | [`scrum-in-sdd.md`](./framework.seeds/templates/EN/scrum-in-sdd.md) · [`app-design.md`](./admin-portal/app-design.md) | - Not started. - Does not replace the Features catalog. - After feature-17, Get secret is on Setup. - Filename retarget is feature-19. | ToDo |
| feature-17 | [Web-portal-13 Get secret moves to Setup](./product-backlog.md#pb-83) | Web-portal | Feature | Move Get secret to Setup | - On `/` and `/instructions`, Setup shows the secret form after the tools table. - Features does not contain `secret-lookup`. - The anchor is `#setup-secret`. - Submit stays on Setup and does not set `?tab=features`. - Hint, button, found value, not-found, empty name, scroll, and lookup-row width stay as feature-05. - The setup sentence and `mcp.json` sample stay without a token. | [ADR-067](./adr/ADR-067-get-secret-on-setup.md) · [`app-design.md`](./admin-portal/app-design.md) · [`13-instructions.html`](./admin-portal/ui-mockup/13-instructions.html) | - Mockup confirmed. - Page matches mockup. - Unit and Playwright green. - Ethan confirmed usable 2026-09-26. | Done |
| feature-18 | [Spec-seeds-02 Seed: scrum-in-sdd.md](./product-backlog.md#pb-33) | Framework | Feature | Rename guide to scrum-in-sdd.md | - EN and HanS seeds exist as `templates/{EN\|HanS}/scrum-in-sdd.md`. - Ethan’s start load names `scrum-in-sdd.md`. - Living specs find no `sdd-scrum-guide.md` except dated history. - Practices stay `sdd-scrum-practices.md`. | [ADR-068](./adr/ADR-068-scrum-in-sdd-filename.md) · [`scrum-in-sdd.md`](./framework.seeds/templates/EN/scrum-in-sdd.md) | - Spec-seeds-02 stays Done for the confirmed EN body. - This row is the rename only. - Install onto `{client_root}` stays pack-copy go-live. - Catalog and mocks are feature-19. | Done |
| feature-19 | [Web-portal-12 Instructions tab: sdd-scrum guide](./product-backlog.md#pb-81) | Web-portal | Feature | Retarget guide name in portal catalog | - The three Features catalog files name `scrum-in-sdd.md`. - Instruction mocks name `scrum-in-sdd.md`. - feature-16 and Web-portal-12 say the future tab reads `scrum-in-sdd.md` with English fallback. - [`app-design.md`](./admin-portal/app-design.md) `/instructions` names that file. - No tab, route, or `InstructionsPage` change. | [ADR-068](./adr/ADR-068-scrum-in-sdd-filename.md) · [`features.en.md`](../src/content/features/features.en.md) · [`app-design.md`](./admin-portal/app-design.md) | - Does not build the guide tab. - Features body changes only because the markdown changes. | Done |
| task-01 | [Web-portal-07 Features tab reads pack features.md](./product-backlog.md#pb-73) | Web-portal | Task | Write the three package files | - `src/content/features/features.en.md`, `features.zh-Hans.md`, and `features.zh-Hant.md` exist. - Each file is markdown. - The three files are not required to use the same headings. - They ship in the server image because the runtime image copies `src/`. | `[app-design.md](./admin-portal/app-design.md)` Features catalog · `Dockerfile` | - Part of feature-07. These files are the fallback, not a second catalog in code. | Done |
| task-02 | [Web-portal-07 Features tab reads pack features.md](./product-backlog.md#pb-73) | Web-portal | Task | Put the files at the pack root | - The Settings GitHub pack root contains `features.en.md`, `features.zh-Hans.md`, and `features.zh-Hant.md`. - Sync unpacks them into `.data/sdd-packages/<commit>/`. - Install and update do not copy those paths onto `{client_root}`. | `[mcp/mcp-design.md](./mcp/mcp-design.md)` sync cache · `[app-design.md](./admin-portal/app-design.md)` | - Install omit unit test passes. Ethan synced the Settings pack on 2026-09-26. The three files are at the unpack root of `30cde7ac`. | Done |
| task-03 | [Web-portal-07 Features tab reads pack features.md](./product-backlog.md#pb-73) | Web-portal | Task | Read the synced file for one locale | - `GET /api/sdd/features?locale=en`, `zh-Hans`, or `zh-Hant` returns that file from the latest cache. - A missing zh file in the cache returns the cache English file, `source` `cache`, and `sourceLocale` `en`. - The route is public and returns no key values. | `src/app/api/sdd/features/route.ts` · `[app-design.md](./admin-portal/app-design.md)` | - Reuse the latest cache directory already used by version listing. - A missing cache is task-05. | Done |
| task-04 | [Web-portal-07 Features tab reads pack features.md](./product-backlog.md#pb-73) | Web-portal | Task | Show the file on the Features tab | - `/` and `/instructions` replace the fixed Agents, Skills, Rules, and Templates lists with `#features-body`. - The body is the server markdown rendered as HTML. - Raw HTML and `javascript:` links in the file are not executed. - Get secret stays after `features-body`. - Setup is unchanged. | `src/components/features/InstructionsPage.tsx` · `[13-instructions.html](./admin-portal/ui-mockup/13-instructions.html)` | - The instructions page still renders when the catalog cannot be read. | Done |
| task-05 | [Web-portal-07 Features tab reads pack features.md](./product-backlog.md#pb-73) | Web-portal | Task | Fallback to the package files | - When the sync cache cannot be read, or it has no English file, the route reads `src/content/features/` for the active locale. - A missing Chinese package file uses the English package file. - The response `source` is `package`. - `features-body` shows that file. - There is no unavailable message. - A previous cache kept after a failed sync stays `source` `cache`. | `[app-stories.md](./admin-portal/app-stories.md)` AC14 | - English fallback inside the cache is task-03. | Done |
| task-06 | [Web-portal-07 Features tab reads pack features.md](./product-backlog.md#pb-73) | Web-portal | Task | Tests and regression | - Write the failing tests before the page change. - Unit covers locale fallback and HTML escaping. - Integration covers `GET /api/sdd/features` for cache and for package fallback. - Component and Playwright cover the cache body, English fallback, and the package files when the cache is missing, on `/` and `/instructions`. - After the feature, regression covers Setup copy, one `mcp.json`, the tools table without `sdd_list_versions`, Get secret found / missing / empty, tab switch, and reset success. | `[app-test.md](./admin-portal/app-test.md)` §7 | - Last task of feature-07. Do not mark feature-07 Done before this regression passes. | Done |
...
- Start load is one numbered list in `agents/ethan.md`. Design §6 Toggle A still says to call install. Agent-07 forbids that call, so the list does not take Toggle A.
...
| Code       | Parent PBI                                                      | Module | Type    | SBI                                             | Acceptance criteria                                              | Related docs | Note | Status |
| ---------- | --------------------------------------------------------------- | ------ | ------- | ----------------------------------------------- | ---------------------------------------------------------------- | ------------ | ---- | ------ |
| feature-01 | [Skill-07 Skill: sdd-tracking](./product-backlog.md#pb-27) | Skill  | Feature | Fill practices job 6 and ship sdd-tracking | - Practices job 6 is written. - The skill installs as `sdd-tracking`. | [ADR-065](./adr/ADR-065-skill-tracking-not-update-status.md) | - Initial `SKILL.md` is Sprint 3 feature-14. | ToDo   |
...
| feature-03 | [Skill-13 Skill: sdd-implement](./product-backlog.md#pb-65)                                            | Skill  | Feature | Skill sdd-implement | - The skill loads the skills the SBI needs, including spec update and TDD, and finishes that one SBI. | [ADR-066](./adr/ADR-066-sdd-design-before-implementation.md) | - Initial `SKILL.md` is Sprint 3 feature-15. | ToDo   |
...
| feature-03 | [Spec-seeds-11 Seed: .secrets](./product-backlog.md#pb-66)        | Framework | Feature | Secrets seed      | - The user has reviewed and confirmed this seed. - It is stored in the seed tree. - Associated specs are updated. - The whole seed tree has been cross-reviewed and is consistent. | `[framework.seeds/templates/EN/scrum-in-sdd.md](./framework.seeds/templates/EN/scrum-in-sdd.md)` | - The guide spells the file `.secrets`. - HanS and HanT are Sprint 15. | ToDo   |
...
| Code       | Parent PBI                                                         | Module | Type    | SBI                                              | Acceptance criteria                                                                                                                                                                                                  | Related docs                                                                                                   | Note                                                                                                                 | Status |
| ---------- | ------------------------------------------------------------------ | ------ | ------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | ------ |
| feature-01 | [i18n-01 Framework definition locales](./product-backlog.md#pb-67) | i18n   | Feature | Add the HanS guide to the seed tree              | - `specs/framework.seeds/templates/HanS/scrum-in-sdd.md` matches `~/.cursor/templates/framework.sdd.works/HanS/scrum-in-sdd.md`, including the `sdd-` skill names.                                             | `[framework.seeds/templates/HanS/scrum-in-sdd.md](./framework.seeds/templates/HanS/scrum-in-sdd.md)`     | - Moved from Sprint 1. - EN guide stays Sprint 1 feature-01.                                                         | Done   |
| feature-02 | [i18n-01 Framework definition locales](./product-backlog.md#pb-67) | i18n   | Feature | Add the HanT guide to the seed tree              | - `specs/framework.seeds/templates/HanT/scrum-in-sdd.md` matches the HanT template meaning, including the `sdd-` skill names.                                                                                                      | `[framework.seeds/templates/EN/scrum-in-sdd.md](./framework.seeds/templates/EN/scrum-in-sdd.md)`         | - Moved from Sprint 1. - Filename is [ADR-068](./adr/ADR-068-scrum-in-sdd-filename.md).                                                                                               | ToDo   |
...
| feature-06 | [MCP-01 Installer: pack allow-list + ledger](./product-backlog.md#pb-16) | MCP | Feature | Go-live: pack copy, binary releases, admin sync | - The finalized seed folder is copied into the framework pack repo and pushed. - GitHub Releases exist for the five `sdd-mcp` binaries. - The admin portal has synced that pack. | [`framework-design.md`](./framework.seeds/framework-design.md#go-live) · [`status.md`](./status.md) | - Moved from Sprint 2. - Sprint 2 installer stories stay Done. - Start after the locale bodies in this sprint are finalized. | ToDo   |
| feature-07 | [Spec-seeds-12 Seeds: features.md at pack root](./product-backlog.md#pb-82) | Framework | Feature | Finalize the three features.md seeds | - The user has reviewed and confirmed `features.en.md`, `features.zh-Hans.md`, and `features.zh-Hant.md`. - The three files sit at the pack repo root. - Associated specs are updated. - Install does not copy them onto `{client_root}`. | [Web-portal-07](./product-backlog.md#pb-73) | - Finish before feature-06 so go-live copies the reviewed files. | ToDo |
