...
**coach-ethan product presence: local Cursor agent** (installable prompt in the client `agents/` tree). Remote MCP stays the installer. Design: [`agent-ethan/agent-design.md`](./agent-ethan/agent-design.md). Decision: [D1](./sprint-backlog.md#rid-d1). Tracking: [Agent-01](./product-backlog.md#pb-6).
