---
title: The 2020 Scrum Guide (review paste)
type: framework-guide
status: review
as_of: 2026-09-22
source_pdf: 2020-Scrum-Guide-US.pdf
source_note: >
  Full conversion of the November 2020 Scrum Guide for local review.
  Official text © 2020 Ken Schwaber and Jeff Sutherland, licensed under
  Creative Commons Attribution Share-Alike 4.0
  (https://creativecommons.org/licenses/by-sa/4.0/).
  HTML port: https://scrumguides.org/scrum-guide.html (direct port of the PDF).
  Prior sdd-scrum stub content is not in this file while under review.
related:
...
### Workflows
As there is no current need for **workflows** at this stage, this folder remains a **placeholder**.

### Knowledge
- **ADR**: Architecture Decision Record, default path: **{workspace-folder}/specs/ADR**
