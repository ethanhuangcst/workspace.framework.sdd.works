...
> **Related**: [`architecture.md`](./architecture.md) · [`deployment.md`](./deployment.md) · [`sprint_plan.md`](./sprint_plan.md) · [`artifacts-map.md`](./artifacts-map.md)
> **Conventions**: Column definitions and status meanings are in [`sdd-scrum-practices.md`](./sdd-scrum-practices.md).
> **Schedule**: The `Sprint` column in the backlog table at the end is a projection of [`sprint_plan.md`](./sprint_plan.md). Schedule changes belong in that file.
...
| <a id="pb-6"></a>6 | [Local] | — | Local startup | The app starts on this machine with the default configuration. | After `make up`, the app shows an empty collection and one card can be cataloged. | [Sprint 1 “Local startup”](./sprint_plan.md#s1-local) · [`deployment.md`](./deployment.md) §1 | Sprint 1 | Done |
